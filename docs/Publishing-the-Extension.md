...
Sideload and capture behaviour is in [Browser capture](Browser-Capture.md). The public privacy policy is [`extensions/PRIVACY.md`](../extensions/PRIVACY.md).
...
`https://github.com/fabimc/garia/blob/master/extensions/PRIVACY.md`
...
Privacy: https://github.com/fabimc/garia/blob/master/extensions/PRIVACY.md
...
1. Replace the sideload instructions in Settings → Capture and in [Browser capture](Browser-Capture.md) with the two store links.
